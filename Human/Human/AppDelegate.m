...
- (void)startComputer:(BOOL)started {
    // check if computer is already started
    if (started) { return; } // if you have a void return value, calling return stops the method
    
    // do something to start computer and get things ready
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    leftArm.hand.thumb = [[Thumb alloc] init];
    
    Arm *rightArm = [[Arm alloc] init];
    
    rightArm.hand = [[Hand alloc] init];
